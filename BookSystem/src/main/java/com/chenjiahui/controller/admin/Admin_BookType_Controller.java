...
import com.chenjiahui.service.BookTypeService;
import com.chenjiahui.service.UserService;
import com.chenjiahui.util.CryptographyUtil;
...
public class Admin_BookType_Controller {
   ...
   /**
	...
	public Map<String, Object> list(@RequestParam(value = "page", required = false) Integer page,
		...
		Pageable pageable=PageRequest.of(page-1,limit, Sort.Direction.ASC,"orderNo");
